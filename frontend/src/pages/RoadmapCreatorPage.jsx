...
const RoadmapCreatorPage = () => {
    ...
    const handleCreatorReset = () => {
        ...
        window.history.pushState({}, '', '/ashutoshkeliyehai');
    };
    ...
    const handleLoadingComplete = () => {
        if (pendingData) {
            ...
            if (pendingData.id) {
                window.history.pushState({}, '', `/ashutoshkeliyehai?roadmapId=${pendingData.id}`);
            }
        }
    };
        ...
        fetch(`${API_BASE_URL}/api/roadmap/${roadmapId}`)
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    setCreatorState(STATES.RESULTS);
                    setShareUrl(`${window.location.origin}/ashutoshkeliyehai?roadmapId=${roadmapId}`);
                } else {
